...
<div class="container-fluid">
 ...
 <?php }?>
 <?= $this->session->flashdata('pesan'); ?>
 <a href="" class="btn btn-success mb-3" data-toggle="modal" data-target="#bukuBaruModal"><i class="fas fa-file-alt"></i> Buku Baru</a>
 ...
 <td>
 <a href="<?= base_url('buku/ubahBuku/').$b['id'];?>" class="badge badge-success"><i class="fas fa-edit"></i> Ubah</a>
 <a href="<?= base_url('buku/hapusbuku/').$b['id'];?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul.''.$b['judul_buku'];?> ?');" class="badge badge-warning"><i class="fas fa-trash"></i> Hapus</a>
 </td>
 </tr>
 <?php } ?>
 </tbody>
...
<div class="modal fade" id="bukuBaruModal" tabindex="-1" role="dialog" aria-labelledby="bukuBaruModalLabel" aria-hidden="true">
 ...
 <?php foreach ($kategori as $k) { ?> <option value="<?= $k['id_kategori'];?>"><?= $k['nama_kategori'];?></option>
 <?php } ?>
 </select>
 </div>
 <div class="form-group">
